                    ...
                    <div className="container mx-auto flex justify-between items-cente text-center">
                        <div className="profile">
                            <div className="img relative group">
                                <img className="  rounded-full overflow-hidden  w-full" src={data.photoURL} alt="photo" />
                    ...
                    <div className="modal">
                        <div className="box">
                            ...
                            <div className="btn flex gap-3 mt-3 justify-center items-center">
                                <button onClick={getCropData} className="Button_v_1">update</button>
                                <button onClick={handaleCancel} className="Button_v_1">cancel</button>
                            </div>
                        </div>
                    </div>
