    ...
    return (
        <div className="all">
            <div className="main ">
                ...
                <div className="img">
                    <button onClick={() => setShow(!show)} className="Button_v_4 rounded-md"> {show ? " cancel" : "createGroup"} </button>
                </div>
            </div>

            {
                show ?
                    <div className=" bg-blue-700 p-4 rounded-lg ">
                        <input value={groupName} onChange={handleGroupName} type="text" placeholder="group name" className=" w-full rounded-md outline-none py-1 px-2 mb-3" />
                        <p className=" text-red-500 font-serif text-sm ">{groupNameError}</p>
                        <input value={groupIntroName} onChange={handleIntroName} type="text" placeholder="group intro" className=" w-full rounded-md outline-none py-1 px-2" />
                        <p className=" text-red-500 font-serif text-sm ">{groupIntroNameError}</p>
                        <button onClick={handleCreateGroup} className="Button_v_4 w-full mt-2 rounded-md">create</button>
                    ...
                    <div>
                       ...
                       groupList.map((item,i)=>{
                            return(
                                ...
                                <div className="btn">
                                    <button onClick={()=>handleGroupJoin(item)} className="Button_v_6">join</button>
                                </div>
