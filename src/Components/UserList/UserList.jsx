    ...
    return (
        <div className="all">
            <div className="main ">
                ...
                <div>
                    <input onChange={handleSearch} type="text" placeholder="search" className=" border border-1 border- border-blue-600 outline-none p-1 rounded-lg " />
                </div>
                <div className="img">
                    <BsThreeDotsVertical />
                </div>
                ...
                return(
                    ...
                    <div className="btn">

                        {
                            ...
                            :
                            <button onClick={()=>handleFriendRequest(item)} className="Button_v_2">addfriend</button>
